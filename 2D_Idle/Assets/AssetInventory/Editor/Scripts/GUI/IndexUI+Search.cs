...
#pragma warning restore CS4014
                    ...
                    {
                        EditorGUI.BeginChangeCheck();
                        AssetInventory.Config.tileSize = EditorGUILayout.IntSlider(AssetInventory.Config.tileSize, 50, 300, GUILayout.Width(150));
                        if (EditorGUI.EndChangeCheck())
                        {
...
#pragma warning restore CS4014
                    ...
                    else
                    {
                        ...
                        GUILabelWithText("In Project", $"{inProject:N0}/{_gridSelectionCount:N0}");
        ...
        private void CalculateBulkSelection()
        {
            ...
            AssetInventory.ResolveParents(_gridSelectionItems, _assets);
        }
