...
namespace AssetInventory
{
    public static class UpgradeUtil
    {
        ...
        public static void PerformUpgrades()
        {
            ...
            if (oldVersion < CURRENT_DB_VERSION && !LongUpgradeRequired)
            {
            ...
            PendingUpgrades = DBAdapter.DB.Table<AppProperty>().Where(a => a.Name.StartsWith("UpgradeType-")).Select(a => a.Name.Substring(12)).ToList();
        }
