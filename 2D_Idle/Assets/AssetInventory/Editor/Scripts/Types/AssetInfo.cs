...
namespace AssetInventory
{
    ...
    public sealed class AssetInfo : AssetFile
    {
        ...
        {
            IEnumerable<UnityEditor.PackageManager.UI.Sample> samples = GetSamples();
        ...
        public IEnumerable<UnityEditor.PackageManager.UI.Sample> GetSamples()
        {
            ...
            return UnityEditor.PackageManager.UI.Sample.FindByPackage(SafeName, installedPackageVersion);
        }
